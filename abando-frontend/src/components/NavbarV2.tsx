  ...
  return (
    <div className="sticky top-0 z-50 bg-[rgba(11,18,32,.95)] backdrop-blur border-b border-white/10">
      <nav className="h-16 max-w-[1120px] mx-auto px-4 flex items-center justify-between">
        <Link
          href="/"
          aria-label="Abando home"
          className="flex items-center gap-2 text-slate-100 no-underline"
        >
          <img
            src="/abando-logo.png"
            alt=""
            ...
            className="block"
          />
          <span className="font-bold">Abando</span>
        ...
        <div className="hidden md:flex items-center gap-2">
          <Link href="/demo/playground" className="btn btn-ghost">
            Open demo
          </Link>
          <Link href="/onboarding?trial=1" className="btn btn-primary">
            Start free trial
          </Link>
        </div>
      </nav>
