    ...
    <div className="sticky top-0 z-50 bg-[rgba(11,18,32,.95)] backdrop-blur border-b border-white/10">
      <nav className="h-16 max-w-[1120px] mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          <Link href="/marketing/demo/playground" data-cta="open_demo" className="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium bg-slate-700 hover:bg-slate-600 text-white shadow-sm">Open demo</Link>
