...
export default async function DiscoverPage() {
  ...
  return <main className="careerShell"><header className="careerHeader"><div><p className="careerEyebrow">CareerOS</p><h1>Discover opportunities</h1><p className="careerMuted">Search approved sources using your own criteria. CareerOS does not send your career profile or application materials to job providers.</p></div><span><a href="/career">CareerOS Home</a> · <a href="/career/jobs">Saved jobs</a></span></header><DiscoverClient initialPreferences={await getSearchPreferences(context)} /></main>;
}
