...
const SOURCE_TYPES = new Set(["RESUME_TEXT", "EMPLOYMENT", "CONSULTING", "MANUAL_WORK_HISTORY", "PROJECT", "ACCOMPLISHMENT", "TECHNICAL_BUILD", "CERTIFICATION", "EDUCATION", "SPEAKING_TEACHING", "LEADERSHIP", "VOLUNTEER_COMMUNITY", "PORTFOLIO_DESCRIPTION", "OTHER_USER_PROVIDED_TEXT"]);
