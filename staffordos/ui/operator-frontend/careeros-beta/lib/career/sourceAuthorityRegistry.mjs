...
export const DEFAULT_SOURCE_AUTHORITY_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    sourceId: "lever-freedompay",
    provider: "LEVER",
    employerName: "FreedomPay",
    siteIdentifier: "freedompay",
    leverSite: "freedompay",
    canonicalSourceUrl: "https://jobs.lever.co/freedompay",
    interfaceType: "LEVER_POSTINGS_API",
    authorityStatus: "AUTHORIZED",
    authorityEvidenceRef: "LEVER_PUBLIC_POSTINGS_THIRD_PARTY_SCRAPING_DOC_AND_FREEDOMPAY_OFFICIAL_CAREERS_LINK_2026-09-02",
    commercialMultiUserAllowed: true,
    storageAllowed: true,
    derivedAnalysisAllowed: true,
    displayAllowed: true,
    attributionText: "Source: Lever / FreedomPay career site",
    sourceLinkRequired: true,
    applyRedirectRequired: true,
  ...
  Object.freeze({
    ...
    leverSite: "dnb",
    leverRegion: "US",
    canonicalSourceUrl: "https://jobs.lever.co/dnb",
    interfaceType: "LEVER_POSTINGS_API",
    authorityStatus: "AUTHORIZED",
    authorityEvidenceRef: "LEVER_PUBLIC_POSTINGS_THIRD_PARTY_SCRAPING_DOC_AND_DNB_OFFICIAL_CAREERS_LINK_2026-09-02",
    commercialMultiUserAllowed: true,
    storageAllowed: true,
    derivedAnalysisAllowed: true,
    displayAllowed: true,
    attributionText: "Source: Lever / Dun & Bradstreet career site",
    sourceLinkRequired: true,
    applyRedirectRequired: true,
    rateLimitPolicy: RATE_LIMIT_POLICY_CONSERVATIVE_UNKNOWN,
    removalPolicy: "REVALIDATE_STOP_PRESENTING_MISSING_OR_CLOSED_NO_RAW_FEED_ARCHIVE",
  ...
  Object.freeze({
    ...
    provider: "LEVER",
    employerName: "Frontify",
    siteIdentifier: "frontify",
    leverSite: "frontify",
    leverRegion: "EU",
    canonicalSourceUrl: "https://jobs.lever.co/frontify",
    interfaceType: "LEVER_POSTINGS_API",
    authorityStatus: "AUTHORIZED",
    authorityEvidenceRef: "LEVER_PUBLIC_POSTINGS_FRONTIFY_OFFICIAL_CAREERS_AND_RECRUITING_PRIVACY_LEVER_REFERENCE_2026-09-02",
    commercialMultiUserAllowed: true,
    storageAllowed: true,
    derivedAnalysisAllowed: true,
    displayAllowed: true,
    attributionText: "Source: Lever / Frontify career site",
    sourceLinkRequired: true,
    applyRedirectRequired: true,
    rateLimitPolicy: RATE_LIMIT_POLICY_CONSERVATIVE_UNKNOWN,
    removalPolicy: "REVALIDATE_STOP_PRESENTING_MISSING_OR_CLOSED_NO_RAW_FEED_ARCHIVE",
