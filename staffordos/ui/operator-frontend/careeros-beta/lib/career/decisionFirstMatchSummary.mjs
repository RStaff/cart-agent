...
export function buildDecisionFirstMatchSummary(match = {}) {
  ...
  else if (coverage === "MEANINGFUL" && counts.DIRECT > 0 && counts.TRANSFERABLE > 0 && counts.SPECIALIST_BLOCKED === 0) assessment = "PROMISING_ALIGNMENT";
  ...
  else if (assessment === "MIXED_ALIGNMENT") bottomLine = "Review the supporting evidence and open requirements carefully before deciding.";
