...
export const STAFFORDOS_CAPABILITIES: StaffordOsCapability[] = [
  ...
  },
  {
    ...
    description: "A future private place to compare roles, track applications, and prepare follow-ups.",
    operatorQuestion: "Which opportunity should I focus on next?",
    currentRoute: null,
    ...
    access: "read_only",
    readiness: "Planned only. StaffordOS does not track jobs or applications here yet.",
  },
  {
  ...
  },
  {
    ...
    workspaceId: "professional",
    source: "planned_architecture",
    title: "Plan My Current Role",
    description: "A future private place to track commitments, stakeholders, accomplishments, and lessons.",
    operatorQuestion: "What work commitment should I protect next?",
    currentRoute: null,
    destinationLabel: "Stays in this planned overview",
    osSection: "knowledge",
    availability: "planned",
