...
const REQUIRED_SHAPE = {
  ...
  technical: {
    ...
    hasPerformanceDegradation: "tri_state",
  },
  traffic: {
...
function toSignalList(input) {
  return [
    ...
    ["hasPerformanceDegradation", input.technical.hasPerformanceDegradation],
...
export function routeRevenueOpportunity(input) {
  ...
  const criticalTechnicalBlocker =
    ...
    input.technical.hasPerformanceDegradation === true;
  ...
  if (fixCandidate === true) {
    ...
    confidenceInputs = [
      ...
      input.technical.hasPerformanceDegradation,
    ];
...
function testRouter() {
  const fixInput = {
    ...
    technical: {
      ...
      hasPerformanceDegradation: "unknown",
    },
  ...
  const degradedFixInput = {
    store: { storeUrl: "https://slow-store.example" },
    technical: {
      hasBrokenPages: false,
      hasAppEmbedIssue: false,
      hasThemeRenderIssue: false,
      checkoutAccessible: true,
      hasPerformanceDegradation: true,
    },
    traffic: { hasMeaningfulTraffic: true },
    conversion: { checkoutFlowVisible: true },
    cartRecovery: { cartRecoveryOpportunity: true },
  ...
  console.log("DEGRADED_FIX", routeRevenueOpportunity(degradedFixInput));
}
