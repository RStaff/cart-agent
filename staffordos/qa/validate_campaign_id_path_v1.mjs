...
const campaignLead = syncLeadLikePath(
  ...
  { domain: "example.com", campaign_id: "campaign_shopifixer_outreach" },
  {}
);
assert(
  campaignLead.campaign_id === "campaign_shopifixer_outreach",
...
const whitespaceCampaignLead = syncLeadLikePath(
  ...
  { domain: "example.org", campaign_id: "  campaign_shopifixer_outreach  " },
  {}
);
assert(
  whitespaceCampaignLead.campaign_id === "campaign_shopifixer_outreach",
...
const loadCampaignLead = loadLeadLikePath({
  ...
  campaign_id: "campaign_shopifixer_outreach",
  source: "staffordos",
  contact: { email: "", confidence: "low" },
  status: { current_stage: "new" }
});
assert(
  loadCampaignLead.campaign_id === "campaign_shopifixer_outreach",
...
assert(
  relationshipFacet.campaign_id === "campaign_shopifixer_outreach",
