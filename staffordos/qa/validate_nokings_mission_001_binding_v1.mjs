...
function run() {
  ...
  assert(actualReport.current_phase === "mission_certification", "current phase is mission_certification after Exercise 010 proof package", failures);
  assert(actualReport.current_blocker === "Mission Certification Missing", "current blocker is Mission Certification Missing after Exercise 010 proof package", failures);
  assert(actualReport.next_safe_action === "Certify Exercise 010", "next safe action is certify Exercise 010", failures);
  ...
  assert(actualReport.gates.after_evidence.status === "pass", "exercise 010 after evidence gate passes when completion evidence is valid", failures);
  assert(actualReport.gates.proof.status === "pass", "exercise 010 proof gate passes when the mission proof package is valid", failures);
