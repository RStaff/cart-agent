...
function run() {
  ...
  assert(actualReport.gates.mission_certification.status === "pass", "exercise 010 mission certification gate passes when the certification memo is valid", failures);
