...
function run() {
  ...
  assert(actualReport.current_phase === "proof_package", "current phase is proof_package after Exercise 010 after evidence", failures);
  assert(actualReport.current_blocker === "Proof Package Missing", "current blocker is Proof Package Missing after Exercise 010 after evidence", failures);
  assert(actualReport.next_safe_action === "Generate Exercise 010 Mission Proof Package", "next safe action is generate Exercise 010 mission proof package", failures);
