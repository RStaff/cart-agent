...
echo "📄 Overwriting api/server.js with minimal unified API (health, log-test, cart-event)…"

cat <<'NODE' > api/server.js
"use strict";
...
echo "✅ api/server.js overwritten with minimal unified handler"
