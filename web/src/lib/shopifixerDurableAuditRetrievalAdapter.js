...
function serializePacketLink(link) {
  return {
    ...
    repairScopeId: link.repairScopeId || null,
    repairApprovalId: link.repairApprovalId || null,
    purpose: link.purpose,
    status: link.status,
    authorizationSource: link.authorizationSource || null,
    authorityFingerprint: link.authorityFingerprint || null,
    authorityVersion: link.authorityVersion || null,
    sourceMetadata: link.sourceMetadata || null,
